...
if __name__ == "__main__":
    ...
    # print(G.trivial_representation.size)
    # print(in_type.size)
    print("rep_O3 size is", rep_O3.size)
    print("rep_O3_pseudo size is", rep_O3_pseudo.size)
    print("rep_TqQJ size is", rep_TqQJ.size)
    print("rep_kin_three size is", rep_kin_three.size)
    print("trivial_representation is", G.trivial_representation.size)
    print("rep_friction size is", rep_friction.size)
    print("get_ground_reaction_forces_rep_two", rep.size)
    print("rep_QJ is", rep_QJ.size)

        
    # print(G)
    # print(G.trivial_representation)
    # print(G.trivial_representation.name)  
