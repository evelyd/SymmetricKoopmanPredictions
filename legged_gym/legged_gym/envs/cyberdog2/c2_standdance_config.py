...
class CyberStandDanceConfig(CyberCommonCfg):
    ...
    class env(CyberCommonCfg.env):
        ...
        latent_dim = 3 * num_single_state
        # num_critic_observations = num_privileged_obs + latent_dim
        num_critic_observations = num_privileged_obs + latent_dim
        vel_cmd = use_vel
        obs_t = ob_t
...
class CyberStandDanceConfigLatentOnly(CyberStandDanceConfig):
    class env(CyberStandDanceConfig.env):
        num_single_state = 42 + 3 + 2 + 1 * int(ob_t) # add command # add hand targets!!
        # latent_dim = 3 * num_single_state
...
class CyberStandDanceCfgPPODAE(CyberCommonCfgPPO):
    class runner(CyberCommonCfgPPO.runner):
        experiment_name = "stand_dance_cyber_dae"
        model_path = "../../experiments/test/S:stand_dance-OS:3-G:C2-H:5-EH:5_DAE-Obs_w:1.0-Orth_w:0.0-Act:ELU-B:True-BN:False-LR:0.001-L:5-128_system=a1/seed=608"
        algorithm_class_name = 'PPODAE'
        max_iterations = 30000
        save_interval = 300

class CyberStandDanceCfgPPOEMLPDAE(CyberStandDanceCfgPPOEMLP):
    class runner(CyberStandDanceCfgPPOEMLP.runner):
        experiment_name = "stand_dance_cyber_emlp_dae"
        model_path = "../../experiments/test/S:stand_dance-OS:3-G:C2-H:5-EH:5_DAE-Obs_w:1.0-Orth_w:0.0-Act:ELU-B:True-BN:False-LR:0.001-L:5-128_system=a1/seed=608"
        algorithm_class_name = 'PPODAE'
        policy_class_name = 'ActorCriticSymm'

class CyberStandDanceCfgPPOEMLPEDAE(CyberStandDanceCfgPPOEMLP):
    class runner(CyberStandDanceCfgPPOEMLP.runner):
        experiment_name = "stand_dance_cyber_emlp_edae"
        model_path = "../../experiments/test/S:stand_dance-OS:3-G:C2-H:5-EH:5_E-DAE-Obs_w:1.0-Orth_w:0.0-Act:ELU-B:True-BN:False-LR:0.001-L:5-128_system=a1/seed=638"
        algorithm_class_name = 'PPODAE'
        policy_class_name = 'ActorCriticSymm'

class CyberStandDanceCfgPPOCDAE(CyberStandDanceCfgPPODAE):
    class runner(CyberStandDanceCfgPPODAE.runner):
        experiment_name = "stand_dance_cyber_cdae"
        model_path = "../../experiments/test/S:stand_dance-OS:3-G:C2-H:5-EH:5_C-DAE-Obs_w:1.0-Orth_w:0.0-Act:ELU-B:True-BN:False-LR:0.001-L:5-128_system=a1/seed=962"

class CyberStandDanceCfgPPOCDAELatentOnly(CyberStandDanceCfgPPOCDAE):
    class runner(CyberStandDanceCfgPPOCDAE.runner):
        experiment_name = "stand_dance_cyber_cdae_latent_only"
        algorithm_class_name = 'PPODAE_LATENT_ONLY'

class CyberStandDanceCfgPPOECDAE(CyberStandDanceCfgPPODAE):
    class runner(CyberStandDanceCfgPPODAE.runner):
        experiment_name = "stand_dance_cyber_ecdae"
        model_path = "../../experiments/test/S:stand_dance-OS:3-G:C2-H:5-EH:5_EC-DAE-Obs_w:1.0-Orth_w:0.0-Act:ELU-B:True-BN:False-LR:0.001-L:5-128_system=a1/seed=881"

class CyberStandDanceCfgPPOECDAELatentOnly(CyberStandDanceCfgPPOECDAE):
    class runner(CyberStandDanceCfgPPOECDAE.runner):
        experiment_name = "stand_dance_cyber_ecdae_latent_only"
        algorithm_class_name = 'PPODAE_LATENT_ONLY'

class CyberStandDanceCfgPPOEMLPCDAE(CyberStandDanceCfgPPOEMLPDAE):
    class runner(CyberStandDanceCfgPPOEMLPDAE.runner):
        experiment_name = "stand_dance_cyber_emlp_cdae"
        model_path = "../../experiments/test/S:stand_dance-OS:3-G:C2-H:5-EH:5_C-DAE-Obs_w:1.0-Orth_w:0.0-Act:ELU-B:True-BN:False-LR:0.001-L:5-128_system=a1/seed=962"

class CyberStandDanceCfgPPOEMLPCDAELatentOnly(CyberStandDanceCfgPPOEMLPCDAE):
    class runner(CyberStandDanceCfgPPOEMLPCDAE.runner):
        experiment_name = "stand_dance_cyber_emlp_cdae_latent_only"
        algorithm_class_name = 'PPODAE_LATENT_ONLY'

class CyberStandDanceCfgPPOEMLPECDAE(CyberStandDanceCfgPPOEMLPEDAE):
    class runner(CyberStandDanceCfgPPOEMLPEDAE.runner):
        experiment_name = "stand_dance_cyber_emlp_ecdae"
        model_path = "../../experiments/test/S:stand_dance-OS:3-G:C2-H:5-EH:5_EC-DAE-Obs_w:1.0-Orth_w:0.0-Act:ELU-B:True-BN:False-LR:0.001-L:5-128_system=a1/seed=881"

class CyberStandDanceCfgPPOEMLPECDAELatentOnly(CyberStandDanceCfgPPOEMLPECDAE):
    class runner(CyberStandDanceCfgPPOEMLPECDAE.runner):
        experiment_name = "stand_dance_cyber_emlp_ecdae_latent_only"
        algorithm_class_name = 'PPODAE_LATENT_ONLY'

class CyberStandDanceCfgPPOCDAEOnline(CyberCommonCfgPPO):
    class runner(CyberCommonCfgPPO.runner):
        experiment_name = "stand_dance_cyber_cdae_online"
...
class CyberStandDanceCfgPPOCDAEOnlineNextLatent(CyberStandDanceCfgPPOCDAEOnline):
    class runner(CyberStandDanceCfgPPOCDAEOnline.runner):
        experiment_name = "stand_dance_cyber_cdae_online_next_latent"

class CyberStandDanceCfgPPOEMLPECDAEOnline(CyberStandDanceCfgPPOCDAEOnline):
    class runner(CyberStandDanceCfgPPOCDAEOnline.runner):
        experiment_name = "stand_dance_cyber_emlp_ecdae_online"
        policy_class_name = 'ActorCriticSymm'

    class koopman(CyberStandDanceCfgPPOCDAEOnline.koopman):
        class model(CyberStandDanceCfgPPOCDAEOnline.koopman.model):
            name = 'ecdae'
            equivariant = True
            group_avg_trick = True
            state_dependent_obs_dyn = False

class CyberStandDanceCfgPPOEMLPECDAEOnlineNextLatent(CyberStandDanceCfgPPOEMLPECDAEOnline):
    class runner(CyberStandDanceCfgPPOEMLPECDAEOnline.runner):
        experiment_name = "stand_dance_cyber_emlp_ecdae_online_next_latent"

class CyberStandDanceCfgPPOCDAEOnlineLatentOnly(CyberStandDanceCfgPPOCDAEOnline):
    class runner(CyberStandDanceCfgPPOCDAEOnline.runner):
        experiment_name = "stand_dance_cyber_cdae_online_latent_only"
        algorithm_class_name = 'PPODAEOnlineLatentOnly'